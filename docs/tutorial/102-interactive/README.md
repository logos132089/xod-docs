...
As you run the simulation, you can run an _interactive session_ on the board also known as debugger. Tweaks and watches go live while running the program on physical hardware.
